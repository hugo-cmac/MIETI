...
class Client:
    ...
    def process(self, msg=b""):
        ...
        if self.msg_cnt == 1:
            ...
            self.s.verifySignature(msg[:256], self.d.Public_key(), self.public_key_server, msg[256:1541])
