...
class Packet {
    ...
    public synchronized int newPacket(byte[] data){
        ...
        switch (p.getType()){
            case 2:
                i = p.getRsuID();
                System.out.print("\u001b[s\u001b[1;40f  {Adicionado: RSU "+ i +"}\u001b[u");
                registID(i);
                break;
            case 3:
                ...
                if (!cars.containsKey(i)) {
                    cars.put(i, registration);
                    System.out.print("\u001b[s\u001b[1;40f  {Adicionado: "+registration+"}\u001b[u");
            ...
            case 4:
                ...
                i = p.getAlertID();
                System.out.print("\u001b[s\u001b[2;40f  {Alerta: "+ i +"}\u001b[u");
    ...
    public void startService(){
        if (!thread){
            ...
            Thread t = new Thread(() -> {
                ...
                String info;
                while(i != 20){
                    info = "Parque de estacionamento: \nLugares livres : "+r.nextInt(30);
